...
xdescribe('Stroke basic', function() {
  ...
  beforeEach(function() {
    ...
    that = new Stroke(fxglyph.unitScaledStrokes[0]);
  });
...
xdescribe('FXGlyph i', function() {
  ...
  beforeEach(function() {
    ...
    fxglyph = new handlib.FXGlyph(glyph);
    that = new Stroke(fxglyph.unitScaledStrokes[1]);
  });
  ...
  describe('extraction', function() {
    ...
    // it('has zero substrokes', function() {
    //   expect(that.subStrokes.length).toEqual(3);
    // });
  });
});
